...
\begin{tikzpicture}[
    ...
    shorten >=1pt,
    auto,
    node distance=2.5cm, % <--- AUMENTEI A DISTÂNCIA PARA DAR ESPAÇO
    semithick,
  ...
  \path (q0) edge node {a / X, R} (q1)
             % Aumentei o bend left para 60 para passar bem por cima do q1
  ...
  \path (q3) edge[loop left] node {Y / R} (q3)
             ...
             % bend right=100 faz uma barriga bem grande por baixo
             % looseness=1.5 deixa a curva mais "aberta" para não bater no q2
